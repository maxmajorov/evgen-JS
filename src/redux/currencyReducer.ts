...
export const currencyReducer = (
  ...
  switch (action.type) {
    case ACTIONS_TYPE.CHANGE_CURRENCY_FIELD_TYPE:
      return {
        ...state,
        ...action.payload, //недостаток в том что не видно что конкретно меняется
      };
    case ACTIONS_TYPE.CHANGE_CHANGE_ACTION:
    case ACTIONS_TYPE.CHANGE_CURRENT_CURRENCY: //Если дублируется
      return {
        ...state,
        ...action.payload,
        amountOfBYN: "",
        amountOfCurrency: "", //зануление полей
      };
